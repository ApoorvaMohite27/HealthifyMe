...
using HealthifyMeFinalProject.Services;
...
namespace HealthifyMeFinalProject
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddDbContext<ApplicationDbContext>(options =>
                {
                    ...
                    string connString = Configuration.GetConnectionString("MyDefaultCoonectionString");
            ...
            services
                .AddSwaggerGen(config =>
                {
                    config.SwaggerDoc("v1", new OpenApiInfo
                    {
                        Version = "v1",
                        Title = "Healthify Me",
                        Description = "Healthify Me Management System - API Version 1.0"
                    });
                });
            ...
            UserManager<ApplicationUser> usermanager)
        {
            ...
            {
                config.SwaggerEndpoint("/swagger/v1/swagger.json", "HealthifyMe Web API v1.0");
            });
            ...
            ApplicationDbContextSeed.SeedApplicationUserAsync(usermanager).Wait();
        }
    }
}
